...
$subscriptionName = 'ST Dev/Test'# Read-Host "Please enter the subscription name"
$location = 'East US' #Read-Host "Please enter the region for azure resources creation"
$environmentName = 'contactdemo' #Read-Host "Please enter the environment name"
$deployToAzure = $false
